...
class TransactionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'customer_name' => 'required_unless:is_guest,false|required_if:id_customer,null|string|max:255',
            'phone' => 'required_unless:is_guest,false|required_if:id_customer,null|string|max:20',
